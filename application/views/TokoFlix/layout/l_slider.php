    ...
    <div id="rev_slider_1" class="banner rev_slider" style="display:none">
        ...
        <ul>
            ...
            <li data-transition="fade" class="slide" data-title='Rush.'>
                ...
                <img class="rev-slidebg" alt='' src="<?=base_url()?>assets/images/slides/slide-kedua.jpg">
                ...
                <div class="tp-caption slide__text margin-slider text-right" 
                     ...
                     Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse arcu neque, <br>feugiat sit amet sodales eu, maximus at ante. Curabitur vitae felis quam. Aenean suscipit <br>ligula suscipit dolor gravida, accumsan ultricies dolor scelerisque.
                </div>
                <div class="tp-caption margin-slider" 
                     ...
                     <a href="#" class="slide__link">check it out</a>
                </div>
            ...
            <li data-transition="fade" class="slide" data-title='Travel worldwide. Create trip film.'>
                ...
                <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
                <img class="rev-slidebg" alt='' src="<?=base_url()?>assets/images/bg-image.jpg">
                <div class="rs-background-video-layer" 
                     data-forcerewind="on" 
                     data-volume="mute" 
                     data-videowidth="100%" 
                     data-videoheight="100%" 
                     data-videomp4="<?=base_url()?>assets/video/intro2.mp4" 
            ...
            <li data-transition="fade" class="slide" data-title='Stop wishing. Start doing.'>
                ...
                <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
                <img class="rev-slidebg" alt='' src="<?=base_url()?>assets/images/slides/slide-pertama.jpg">
