...
<header class="header-wrapper header-wrapper--home">
    <div class="container">
        ...
        <a href='<?=base_url()?>' class="logo">
            <img alt='logo' src="<?=base_url()?>assets/images/logo_tokoflix.png">
        </a>
         ...
         <!--    <div class="auth auth--home">
              <div class="auth__show">
                <span class="auth__image">
                  <img alt="" src="<?=base_url()?>assets/images/client-photo/auth.png">
                </span>
              </div>
            ...
            <a href="#" class="btn btn-md btn--default btn--book btn-control--home login-window" >My Wallet : Rp <span id="mywallet">-</span>,00</a>
            <a href="#" class="btn btn-md btn--warning btn--book btn-control--home login-window">Buy a movie</a>
        </div>
